...
To get a more precise answer I subset the data by interval pulling out the observation with the maximum average steps:
...
<!--By imputing values using the mean, I reinforced the structures in the data.-->
